...
export default function Sidebar() {
  ...
  return (
    <aside className="w-full md:w-[300px] flex-shrink-0 bg-glass border-glass rounded-2xl p-6 md:p-8 flex flex-col items-center gap-6 text-center shadow-2xl relative overflow-hidden group hover:border-glass-hover transition-all duration-300">
      ...
      {/* Avatar Container */}
      <div className="relative w-36 h-48 md:w-44 md:h-[235px] flex-shrink-0 rounded-xl overflow-hidden border-2 border-mint-primary/20 shadow-lg group-hover:border-mint-primary/40 transition-all duration-300">
        {!imgError ? (
          <Image
          ...
          <div className="w-full h-full bg-gradient-to-br from-mint-secondary/30 to-bg-base flex items-center justify-center">
            <span className="text-4xl font-semibold text-mint-primary font-heading font-sans">FR</span>
          </div>
        )}
      </div>
      ...
      <div className="w-full flex flex-col gap-3.5 z-10">
        ...
        >
          ...
          <div className="flex flex-col items-start min-w-0 text-left">
            <span className="text-[9px] uppercase tracking-wider text-text-muted font-medium">Email</span>
            <span className="text-xs text-text-body font-medium truncate max-w-[170px] group-hover/item:text-mint-light transition-all duration-300">
        ...
        >
          ...
          <div className="flex flex-col items-start text-left">
            <span className="text-[9px] uppercase tracking-wider text-text-muted font-medium">Phone</span>
        ...
        <div className="flex items-center gap-4 p-3 rounded-xl bg-bg-base/40 border border-mint-primary/5 hover:border-mint-primary/20 transition-all duration-300">
          ...
          <div className="flex flex-col items-start text-left">
            <span className="text-[9px] uppercase tracking-wider text-text-muted font-medium">Location</span>
      ...
      <div className="flex flex-col gap-4 w-full z-10">
        ...
        <a
          href="/resume.pdf"
          download
          className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-gradient-to-r from-mint-primary to-mint-secondary text-bg-base font-semibold text-sm hover:opacity-95 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 shadow-[0_0_15px_rgba(16,185,129,0.2)]"
        >
          <FileText size={16} />

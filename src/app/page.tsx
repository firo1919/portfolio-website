    ...
    return (
        <>
            ...
            <div className="md:hidden flex flex-col h-screen bg-bg-base transition-colors duration-300 overflow-hidden relative">
                ...
                <nav
                    aria-label="Primary"
                    className="shrink-0 z-20 bg-glass border-t border-mint-primary/10 px-2 py-2 flex items-center justify-around backdrop-blur-md shadow-[0_-4px_20px_rgba(0,0,0,0.15)]"
                >
                    {(
                        [
                            "about",
